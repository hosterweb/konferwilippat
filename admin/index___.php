...
<head>
  ...
  <title>Pendaftaran Konferensi Wilayah Jawa Timur Ikatan Notaris Indonesia</title>
  <!--favicon-->
	    	...
	    	<div class="card mb-0">
	    	   <div class="bg-signup2"></div>
	    		<div class="card-img-overlay rounded-left my-5">
                 <h5 class="text-white">PENDAFTARAN KONFERWIL JAWA TIMUR IKATAN NOTARIS INDONESIA</h5>
                <p class="card-text text-white pt-3" style="border:1px solid #FFF" align="center"  padding:10px;>TATA CARA PENDAFTARAN</p><br>
                <p class="card-text text-white pt-3" style="padding:10px; border:1px solid #FFF" align="left";>
                1.  Isi Formulir Pendaftaran dan Upload Data, lalu klik DAFTAR <br><br>
                2.  Selanjutnya Pendaftar mendapatkan email balasan dan whatsapp untuk jumlah yang harus dibayar melalui VIRTUAL ACCOUNT, maximal pembayaran 1x24 jam, apabila lewat waktu tersebut maka pendaftaran hangus dan wajib untuk daftar online kembali.<br><br>
               PESERTA YANG MELEWATKAN BATAS WAKTU PEMBAYARAN MAKA SYSTEM AKAN MENGHAPUS INPUT PENDAFTARAN PESERTA DAN HARUS MENDAFTAR KEMBALI DALAM 1X24 JAM, Reminder Pembayaran by sistem melalui Whatsapp.
                </p>
                <br>
<p class="card-text text-white pt-3" style="padding:10px; border:1px solid #FFF" align="center">                 PERLU DI PERHATIKAN!!! </p><br><br>
<p class="card-text text-white pt-3" style="border:1px solid #FFF;padding:10px;" align="left" >
                 - Peserta harus berusia di bawah 65 Tahun per 28 Agustus 2019<br>
	    	...
	    	<div class="card mb-0">
	    		<div class="card-body">
	    			<div class="card-content p-3">
                        ...
                        <h5 class="text-black">FORMULIR PENDAFTARAN KONFERENSI WILAYAH JAWA TIMUR </h5><br>
                        <h5 class="text-black">IKATAN NOTARIS INDONESIA</h5>
					 	</div>
                        <div class="text-dark" align="left" style="background-color:#d7be40; padding:20px">
                <p class="card-text text-black pt-3" align="left"  padding:10px;><strong>Assalamualaikum Wr. Wb.
                </strong><br>
                <strong>Salam Sejahtera.</strong>
   
                <p class="card-text text-black pt-3" align="left";>
                Pengurus Wilayah Jawa Timur <strong>IKATAN NOTARIS INDONESIA</strong> menyelenggarakan <strong>KONFERENSI WILAYAH JAWA TIMUR IKATAN NOTARIS INDONESIA</strong>, yang akan dilaksanakan pada :<br><br>
                - Hari/Tgl               : <strong>SENIN / 23 SEPTEMBER 2019.</strong><br>
				- Pukul                      &nbsp;&nbsp;&nbsp;&nbsp;:  <strong>07.00 WIB s/d selesai.</strong><br>
				- Tempat                     &nbsp;:  <strong>Dyandra Convention Center , Jl. Basuki Rahmat 105, Surabaya</strong><br>
                - Peserta                    &nbsp;: <strong>Anggota INI JATIM</strong>
                </p>
                <br>
<p class="card-text text-black pt-3" align="left"><strong>TATA CARA PENDAFTARAN</strong></p>
                 1. Gunakan Browser <strong>Google Chrome.</strong><br>
                 2. Mengisi Formulir Pendaftaran melalui website <strong>www.konferwil.pengwiljatimini.com</strong><br>
                 3.	Melakukan pembayaran sesuai dengan perintah bayar dengan jumlah dan nomer rekening &nbsp;&nbsp;&nbsp;&nbsp;yang tercantum di email balasan, dengan batas waktu pembayaran 1X24 jam.
                 <br>4. Mencetak <strong>ID CARD / Tanda Peserta</strong> sendiri dengan kertas <strong>BC 100gr,</strong> jangan menggunakan &nbsp;&nbsp;&nbsp;&nbsp;kertas Foto/Glossy.<br>
                 5. Pada saat <strong>Registrasi Ulang,</strong>Peserta <strong>WAJIB</strong> membawa : <br>
                           &nbsp;&nbsp;&nbsp;&nbsp;- Asli KTP/<br>
                           &nbsp;&nbsp;&nbsp;&nbsp;- ID CARD / Tanda Peserta<br>
<p class="card-text text-black pt-3" align="left"><strong><u>CATATAN:</u></strong></p>
- Bagi Pendaftar dengan perpanjangan Jabatan harap menghubungi CP terlebih dahulu.<br>
- Pendaftaran di <strong>BUKA</strong> hari <strong>Jumat, Tanggal 23 Agustus 2019,</strong>dan di <strong>TUTUP </strong>hari Rabu, tanggal <strong>18 &nbsp;&nbsp;September 2019,</strong>pukul 12.00 WIB<br>
- Informasi Pendaftaran / Contact Person (CP) :<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. Lily Marinie		     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 0812-3057-2377<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Hendrita Vira Yona : 0812-310-6533<br><br>
<strong>Waalaikumsalam, Wr. Wb.</strong><br>
<strong>Panitia Pelaksana</strong><br>
<strong>PENGURUS WILAYAH JAWA TIMUR IKATAN NOTARIS INDONESIA</strong>    
                 </p>
                        </div>
<?php
	if(isset($_POST['nik'])){
	...
	$u=mysqli_query($koneksi, "SELECT * FROM pendaftaran where id=$nama_lengkap");
	...
	$tgl_pendaftaran=date("Y-m-d H:i:s");
				...
				$tgl_acara=strtotime("25-09-2019");
//$kurangi2= $tgl_acara - $tgl_lahir;
//$sel2=floor($kurangi2 / (60 * 60 * 24));
$selisihnya       = $tgl_acara - $tgl_lahir;
$sel2=floor($selisihnya / (60 * 60 * 24));
...
if($j=="jpg"){
	?> 
 <td><a target="_blank" href="images/<?php echo $data['file_ktp'];?>"><img width="125px" src="admin/assets/images/image.png"></a></td>
    <?php
	}
	else {
		?>
 <td><a target="_blank" href="images/<?php echo $data['file_ktp'];?>"><img width="125px" src="admin/assets/images/pdf.jpg"></a></td>
<?php } ?>                        
...
if($j1=="jpg"){
	?> 
 <td><a target="_blank" href="images/<?php echo $data['file_kta'];?>"><img width="125px" src="admin/assets/images/image.png"></a></td>
    <?php
	}
	else {
		?>
 <td><a target="_blank" href="images/<?php echo $data['file_kta'];?>"><img width="125px" src="admin/assets/images/pdf.jpg"></a></td>
<?php } ?>                        
...
if($j2=="jpg"){
	?> 
 <td><a target="_blank" href="images/<?php echo $data['file_sk'];?>"><img width="125px" src="admin/assets/images/image.png"></a></td>
    <?php
	}
	else {
		?>
 <td><a target="_blank" href="images/<?php echo $data['file_sk'];?>"><img width="125px" src="admin/assets/images/pdf.jpg"></a></td>
<?php } ?>                                                
                        </tr>
...
if($j4=="jpg"){
	?> 
 <td><a target="_blank" href="images/<?php echo $data['file_ba'];?>"><img width="125px" src="admin/assets/images/image.png"></a></td>
    <?php
	}
	else {
		?>
 <td><a target="_blank" href="images/<?php echo $data['file_ba'];?>"><img width="125px" src="admin/assets/images/pdf.jpg"></a></td>
<?php } ?>                        </tr>
...
<input name="file_foto" type="text"  style="display:none" value="<?php echo $data['file_foto'];?>">
                         ...
                         <button type="submit" class="btn btn-outline-primary btn-block waves-effect waves-light">DAFTAR</button></td></tr></table>
				   ...
				   <hr>
					...
					<div class="form-group">
                            ...
                            <?php if(empty($nama_lengkap)){?>
                             ...
                             $j=mysqli_query($koneksi,"SELECT * FROM pendaftaran where id='$nama_lengkap'");
					$k=mysqli_fetch_array($j);
					echo $k['nama_lengkap']; ?>
                             <option value="<?php echo $k['nama_lengkap'];?>"><?php echo $k['nama_lengkap'];?></option>
						<?php
                             }
								include "koneksi.php";
                                    $pegawai = mysqli_query($koneksi,"SELECT * FROM pendaftaran");
                                ...
                                ?>
                                        ...
                                        <!-- <input type="text" name="pengda" id="pengda" value="<?php //echo $sel2;?>" class="form-control text-uppercase required" placeholder="Pengda" required readonly>   -->
												<input type="text" name="pengda" id="pengda" value="<?php if(!(empty($pengda))){ echo $pengda; };?>" class="form-control text-uppercase required" placeholder="Pengda" required readonly>
											</div>
...
<input type="text" name="telp_kantor" maxlength="100" required onkeypress="return hanyaAngka(event)" value="<?php if(!(empty($telp_kantor))){ echo $telp_kantor; };?>" class="form-control required" /></td></tr>
</table>
											</div>
										
											<div class="form-group">
                                              <label for="input-13">Alamat Kantor(*)</label>                                            
												<textarea  cols="5" rows="5" name="alamat_kantor" class="form-control text-uppercase required">
                                    ...
                                    <div class="card-title text-uppercase text-center py-3">Upload Dokumen</div>
											...
											<div class="form-group">
                                            <label for="input-13">PAS Foto Berwarna FULLFRAME jangan di SCAN ukuran 4x6 <br>(jpg,png,jpeg Max. 5Mb)*</label>
