 ...
 <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Data Userlog</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="">Home</a></li>
            <li class="breadcrumb-item"><a href="">Userlog</a></li>
         </ol>
	   </div>
...
if($hapus){	
 ...
 <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Data Userlog</div>
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <?php 
				$no=0;
				$x=mysqli_query($koneksi,"SELECT * FROM userlog order by id DESC");
				while($ambil=mysqli_fetch_array($x)){
				$no++
				?>
                    <tr>
                     	<td><?php echo $no;?></td>
                        <td><?php echo $ambil['operator'];?></td>
                        <td><?php echo $ambil['peserta'];?></td>
                        <td><?php echo $ambil['aktifitas'];?></td>
                        <td><?php echo $ambil['tgl'];?></td>
                    </tr>
                    <?php }?>
