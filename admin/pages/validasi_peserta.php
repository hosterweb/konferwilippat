...
$nama=$_SESSION['nama'];
	...
	mysqli_query($koneksi, "UPDATE pendaftaran_ini SET status_pembayaran='1', status_expired='2' where id_pendaftaran='$id_pendaftaran'");
	mysqli_query($koneksi, "UPDATE bukti_pembayaran SET status='1' where id_pendaftaran='$id_pendaftaran'");
	
$nama_peserta=$b['nama_lengkap'];
$tgl_validasi=date("d-m-Y H:i:s");
$konten="Validasi Peserta ";
...
$data = array(
  "phone_no"  => $hpne,
  "key"       => $key,
  "message"   => "*SELAMAT Anda  telah terdaftar sebagai PESERTA Konferensi Wilayah Jawa Timur IPPAT*
...
PESERTA Konferensi Wilayah Jawa Timur IPPAT</h5>
<table border='0' 
...
4.  Membawa Hasil Antigen dan Memakai Masker;</strong><br>
