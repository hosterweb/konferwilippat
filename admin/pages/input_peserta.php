...
$tgl_acara = strtotime('2022-01-22');
...
$data=mysqli_fetch_array($g);
				   ...
				   <hr>
                    ...
                    <tr><td><label for="input-13">Nama Lengkap</label></td><td>:</td><td><?php echo $data['nama_lengkap']?></td></tr>
...
echo "<div class='exists' style='color:red'>
			...
			echo "<div class='exists' style='color:red'>
				  <strong>Maaf!</strong> Usia Anda Tidak Memenuhi Kriteria.
						...
						?>  					    
<a href="?page=peserta_pensiun"><button type="submit" class="btn btn-outline-primary btn-block waves-effect waves-light">DAFTAR PESERTA PENSIUN</button></a>
			     ...
			     <div class="card-body">
				   ...
				   <hr>
					...
					<div class="form-group">
							...
							<input type="text" name="nama_lengkap" class="form-control required"  value="<?php if(!(empty($nama_lengkap))){ echo $nama_lengkap; };?>" />
											</div>
...
<select class="form-control single-select required"  name="pengda">
                            <?php if(empty($pengda)){?>
                             <option>---</option>
                             <?php }
                             else {
					...
					?>
                             <option selected value="<?php echo $pengda;?>"><?php echo $pengda;?></option>
						<?php
                             }
								include "koneksi.php";
                                    $pegawai = mysqli_query($koneksi,"SELECT * FROM pendaftaran group by pengda order by pengda ASC");
								...
								<input class="form-control required"  type="text" name="nik"  value="<?php if(!(empty($nik))){ echo $nik; };?>"  maxlength="16" required onkeypress="return hanyaAngka(event)" placeholder="No NIK KTP"/>	
											...
											<div class="form-group">
                                            <label for="input-13">No. SK Pengangkatan PPAT(*)</label>
										    ...
										    <div class="form-group">
                                            <label for="input-13">Tanggal SK Pengangkatan PPAT (DD/MM/YYYY)*</label>
...
<input type="text" name="telp_kantor" maxlength="8" required onkeypress="return hanyaAngka(event)" value="<?php if(!(empty($telp_kantor))){ echo $telp_kantor; };?>" class="form-control required" /></td></tr>
                                    ...
                                    <div class="card-title text-uppercase text-center py-3">Upload Dokumen</div>
										    ...
										    <div class="form-group">
                                            <label for="input-13">SK PPAT (PDF maskimal berukuran 5Mb)*</label>
												<input type="file" name="file_sk" class="form-control" required placeholder="Upload File SK">
											</div>
										
											<div class="form-group">
                                            <label for="input-13">BA PPAT (PDF maskimal berukuran 5Mb)*</label>
