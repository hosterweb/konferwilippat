	 ...
	 <div class="row">
		...
		<div class="card-body">
		 <div class="card-content p-1">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Absensi Sesi 2 <br> Konferensi Wilayah Jawa Timur<br>Ikatan Pejabat Pembuat Akta Tanah (IPPAT)</div>
          			<?php
 session_start();
...
?>
	...
	$aa=mysqli_query($koneksi, "SELECT * FROM pendaftaran_ini where id_pendaftaran='$id_pendaftaran' AND status_pembayaran='1'");
	...
	?>
        <h4 style="color:green; text-align:center">Absensi Sukses</h4>
...
<table id="example" class="table table-bordered" style="font-size:8pt" width="100%">
    <tr><td colspan="4"><img src="../images/<?php echo $bb['file_foto']?>" class="rounded mx-auto d-block" style="width:75px;"></td></tr>
    <tr>
    <td width="5%"><?php echo $bb['id_pendaftaran']?></td>
    <td width="70%"><?php echo $bb['nama_lengkap']?></td>
    <td width="10%">Pengda <?php echo $bb['pengda']?></td>
	...
	$cari2=mysqli_query($koneksi, "SELECT * FROM pendaftaran_ini where id_pendaftaran='$id_pendaftaran' AND status_pembayaran='1'");
	$hasil_cari2=mysqli_num_rows($cari2);
	if($hasil_cari2>0){
	?>
			    <h4 style="color:red; text-align:center">Belum Melakukan Absen Sesi 1</h4>
