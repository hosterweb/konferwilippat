...
$nama_file="DATA_ABSENSI_PESERTA_SESI_1_PENGDA_".$pengda.".xls";
...
<table width="100%" align="center" style="border:0px">
                  ...
                  <tr><td colspan="6" align="center"><h3>IKATAN PEJABAT PEMBUAT AKTA TANAH</h3></td> </tr>
                  <tr><td colspan="6" align="center"><h3>PENGDA <?php echo $pengda;?></h3></td> </tr>
                  <tr><td colspan="6" align="center"><h3>SESI 1</h3></td> </tr>                                
</table>
<br><br>
              <table id="example" class="table table-bordered" border='1 solid black' width="100%">              
                ...
                <?php 
				$no=0;
				$x=mysqli_query($koneksi,"SELECT * FROM absen where jenis_absen='1' AND pengda='$pengda'");
