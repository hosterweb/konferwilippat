...
<table border="0" width="100%" style="position:absolute; left:30px; top:160px; width: 8.5cm;">
<tr><td width="30%" align="center" style="font-size:16px; color:000;"><img src="images/<?php echo $data['file_foto'];?>" align="middle" style="height:2.8cm;" height="2.8cm"></td></tr>
<tr><td width="30%" align="center" style="font-size:18px; color:000;"><b><?php echo $data['nama_lengkap'];?></b></td></tr>
...
<table border="0" width="8cm" style="position:absolute; left:26px; top:324px; height: 0px; width: 337px;">
